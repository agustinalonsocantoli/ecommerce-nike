...
export const CartCount = ({ onCartToggle, onClearCartItems, cartTotalQuantity }) => {
    return(
        <div>
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <div>
                        <h1 className='text-base font-medium text-slate-900'>
                            Your Cart
                            <span className='bg-theme-cart rounded px-1 ml-1 py-0.5 text-slate-100 font-normal text-xs'>({cartTotalQuantity} items)</span>
                        </h1>
                    </div>
                </div>
